...
# ДЕФОЛТНЫЕ ЗНАЧЕНИЯ
# =====================================================================
DEFAULT_ORDER_VALUE_CONTACT_SOCIAL_LINK = 1
SOCIAL_ORDER_MIN_VALUE = 1
SOCIAL_ORDER_MAX_VALUE = 5
...
HELP_SOCIAL_ORDER = _('Число от 1 до 5. Порядок определяет последовательность отображения иконок на сайте')
