...
HELP_LIMIT_500 = _('Максимум 500 символов.')

FIELD_HERO_TITLE_HELP = _('Крупный заголовок главного вводного блока страницы. ') + HELP_LIMIT_100
FIELD_HERO_DESC_HELP = _('Краткий вводный текст, подзаголовок или слоган. ') + HELP_LIMIT_500
...
FIELD_FIRST_SENTENCE_HELP = _('Первое предложение. Фронтенд выделит его жирным шрифтом или цветом. ') + HELP_LIMIT_500
...
FIELD_VALUE_TEXT_HELP = _('Детальное описание сути этой ценности. ') + HELP_LIMIT_500
