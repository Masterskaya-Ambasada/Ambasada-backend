...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['project', 'order'], name='projects_pr_project_0fc6bc_idx'),
        ),
        migrations.AddIndex(
            model_name='projectblockbutton',
            index=models.Index(fields=['block', 'order'], name='projects_pr_block_i_981fbb_idx'),
        ),
        migrations.AddIndex(
            model_name='project',
            index=models.Index(fields=['is_published', 'slug'], name='projects_pr_is_publ_27cef9_idx'),
        ),
        migrations.AddIndex(
            model_name='project',
            index=models.Index(fields=['is_published', 'title'], name='projects_pr_is_publ_0d60b6_idx'),
        ),
    ]
